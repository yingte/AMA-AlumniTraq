...
class MediaHandlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create media_handle" do
    assert_difference('MediaHandle.count') do
      post media_handles_url, params: { media_handle: { alumnus_id: @media_handle.alumnus_id, link: @media_handle.link, platform: @media_handle.platform } }
    end
  ...
  test "should update media_handle" do
    patch media_handle_url(@media_handle), params: { media_handle: { alumnus_id: @media_handle.alumnus_id, link: @media_handle.link, platform: @media_handle.platform } }
