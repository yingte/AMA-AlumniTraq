...
class AlumniControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alumnus" do
    assert_difference('Alumnus.count') do
      post alumni_url, params: { alumnus: { availability: @alumnus.availability, bio: @alumnus.bio, employer: @alumnus.employer, job_title: @alumnus.job_title, user_id: @alumnus.user_id } }
    end
  ...
  test "should update alumnus" do
    patch alumnus_url(@alumnus), params: { alumnus: { availability: @alumnus.availability, bio: @alumnus.bio, employer: @alumnus.employer, job_title: @alumnus.job_title, user_id: @alumnus.user_id } }
